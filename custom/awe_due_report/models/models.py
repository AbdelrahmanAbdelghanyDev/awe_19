...
class CustomAccountFollowupReport(models.AbstractModel):
    ...
    def _get_columns_name(self, options):
        ...
        headers = [
            ...
            {'name': _('Purchase Number'), 'style': 'text-align:center; white-space:nowrap;'},
    ...
    def _get_lines(self, options, line_id=None):
        ...
        for currency, aml_recs in res.items():
            ...
            for aml in aml_recs:
                ...
                purchase_number = aml.move_id.po_num or ''
                if self.env.context.get('print_mode'):
                    purchase_number = {'name': purchase_number, 'style': 'text-align:right; white-space:normal;'}
