odoo.define('awe_statement_seq_new.ReconciliationRenderer', function (require) {
"use strict";

var Widget = require('web.Widget');
var StatementRenderer = require('account.ReconciliationRenderer');
 ...
 */
StatementRenderer.LineRenderer.include({
    ...
    _renderCreate: function (state) {
        ...
        return this.model.makeRecord('account.bank.statement.line', [{
            ...
            self.fields.analytic_tag_ids.appendTo($create.find('.create_analytic_tag_ids .o_td_field'))
                       .then(addRequiredStyle.bind(self, self.fields.analytic_tag_ids));
